...
function setup() {
	...
	bobObject1 = new Bob(200,450,25)
	bobObject2 = new Bob(250,450,25)
	bobObject3 = new Bob(300,450,25)
	bobObject4 = new Bob(350,450,25)
	bobObject5 = new Bob(400,450,25)
	roofObject = new Roof(300,250,275,20)
